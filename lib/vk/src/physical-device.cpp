...
namespace vk {
	...
	Result<Vec<VkPhysicalDevice>, PhysicalDeviceEnumErr> PhysicalDevice::enumerateImpl(Ref<Instance> instance) {
		u32 size;
	...
	PhysicalDevice::PhysicalDevice(Ref<Instance> instance, VkPhysicalDevice vk) : instance(instance), vk(vk) {}
}
